...
/**
 * Represents the "... type" portion of a {@link Record}. It is typically found
 * in positions 5-6 of a line from the OCR file. This can specifically be known as
 * "Forsendelsestype", "Oppdragstype" or "Transaksjonstype".
 */
public enum Type {
